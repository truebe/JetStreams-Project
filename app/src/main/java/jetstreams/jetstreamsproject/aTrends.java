...
public class aTrends extends AppCompatActivity {

    public static final String MonthOfarray = "MonthOf";
    public static final String Month  = "MonthOf";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_atrends);
    ...
    private void getdata() {
        StringRequest stringRequest = new StringRequest("http://cis444.cs.csusm.edu/trueb003/CS%20441/getdata.php",
    ...
    private void details(JSONArray j) {
        ...
        spinner.setAdapter(new ArrayAdapter<String>(aTrends.this, android.R.layout.simple_spinner_dropdown_item, arrayList));
    }
