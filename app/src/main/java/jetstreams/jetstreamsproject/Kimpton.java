...
public class Kimpton extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kimpton);
    ...
    private void getdata() {
        StringRequest stringRequest = new StringRequest("http://cis444.cs.csusm.edu/trueb003/CS%20441/getdatakimpton.php",
    ...
    private void details(JSONArray j) {
        ...
        spinner.setAdapter(new ArrayAdapter<String>(Kimpton.this, android.R.layout.simple_spinner_dropdown_item, arrayList));
    }
