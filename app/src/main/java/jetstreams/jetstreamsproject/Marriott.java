...
public class Marriott extends AppCompatActivity {
    ...
    private void getdata() {
        StringRequest stringRequest = new StringRequest("http://cis444.cs.csusm.edu/trueb003/CS%20441/getdatamarriott.php",
    ...
    private void details(JSONArray j) {
        ...
        spinner.setAdapter(new ArrayAdapter<String>(Marriott.this, android.R.layout.simple_spinner_dropdown_item, arrayList));
    }
