        ...
        setContentView(R.layout.activity_splash);
            ...
            signIn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if(!isEmpty(mEmail.getText().toString())
                        ...
                        Toast.makeText(SplashActivity.this, "You didn't fill in all the fields.", Toast.LENGTH_SHORT).show();
                    }
                }
            });
            ...
            resendEmailVerification.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    dialog.show(getSupportFragmentManager(), "dialog_resend_email_verificaition");
                }
            });
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null){
                    if (user.isEmailVerified()) {
                        ...
                        Toast.makeText(SplashActivity.this, "Authenticated with: " + user.getEmail(),
                        ...
                        Toast.makeText(SplashActivity.this, "Check your E-mail for a Verification Link",
                                Toast.LENGTH_SHORT).show();
